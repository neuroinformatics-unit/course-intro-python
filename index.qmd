...
format:
    revealjs:
        ...
        footer: "[neuroinformatics.dev/course-intro-python](https://neuroinformatics.dev/course-intro-python) | 2025"
        slide-number: c
        menu:
            numbers: true
        chalkboard: true
...
## Install `git` {.smaller}
* [Install Git](https://git-scm.com/downloads) - version control system
